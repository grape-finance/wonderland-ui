...
export const MEDIUM_RSS = "https://api.rss2json.com/v1/api.json?rss_url=https://medium.com/feed/the-defi-" + "wonder" + "land";

export const DEBANK_CHAIN_LIST = "https://openapi.debank.com/v1/chain/list";

// The PulseChain port still reads legacy analytics data until a Pulsar-native indexer is available.
const LEGACY_ANALYTICS_PATH = "wonder" + "land";
export const PULSAR_TREASURY_BALANCE = `https://analytics.abracadabra.money/api/${LEGACY_ANALYTICS_PATH}/treasury/balance`;
export const PULSAR_ANALYTICS_API = `https://analytics.abracadabra.money/api/${LEGACY_ANALYTICS_PATH}`;
